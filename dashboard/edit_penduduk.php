    ...
    <div class="modal-content">
      <div class="container-fluid" style="margin-bottom: 30px">
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = mysql_query("UPDATE data_penduduk SET NIK='$NIK', nama='$nama', alamat='$alamat', dusun='$dusun', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', jenis_kelamin='$jenis_kelamin', status_perkawinan='$status_perkawinan', pekerjaan='$pekerjaan', gol_darah='$gol_darah', agama='$agama', pendidikan='$pendidikan', ibu='$ibu', ayah='$ayah', no_kk='$no_kk' WHERE id='$id'") or die(mysql_error($koneksi));
