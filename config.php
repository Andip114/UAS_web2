...
$dbname = 'kependudukan'; //Nama Database Aplikasi Enkirpsi dan Dekripsi
$connect = mysql_connect($host, $user, $pass) or die(mysqli_error()); //Mencoba terhubung apabila Host, User, dan Pass Benar. Kalau tidak MySQL memberikan Notif Error
